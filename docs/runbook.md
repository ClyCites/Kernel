...
| An objection stops the subject's own reads as well as everyone else's | Confirmation that this is the right reading of "shall stop". The conservative choice was taken. A farmer who wants their records served again withdraws the objection. See 0030. |
...
| Parties who already received data are not notified when an objection is lodged | Work order J4. Until then an objection stops future disclosure only, and the response says so. |
